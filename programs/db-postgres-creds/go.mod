module github.com/shivanshs9/iac-pulumi/programs/db-postgres-creds
...
require (
	...
	github.com/shivanshs9/iac-pulumi/components v0.0.0
)
...
replace github.com/shivanshs9/iac-pulumi/components => ../../components
